...
const CompanyOverview = () => {
    ...
    return (
        <Wrapper>
            <div className="justify-end hidden mt-24 sm:flex ">
                <div className="space-y-5 sm:w-full lg:w-757 xl:w-811">
                    <ul className="flex gap-10.5 items-center py-5">
                        <li onClick={()=>changeActiveTab("about")} className={"cursor-default text-2xl leading-extra -tracking-tighter transition-all ease-in-out duration-300 "+(activeTab==="about"?"text-purple underline underline-offset-4":"text-primaryGray-300")}><p>About us</p></li>
                        <li onClick={()=>changeActiveTab("what we do")} className={"cursor-default text-2xl leading-extra -tracking-tighter transition-all ease-in-out duration-300 "+(activeTab==="what we do"?"text-purple underline underline-offset-4":"text-primaryGray-300")}><p>What we do</p></li>
                        <li onClick={()=>changeActiveTab("hiring")} className={"cursor-default text-2xl leading-extra -tracking-tighter transition-all ease-in-out duration-300 "+(activeTab==="hiring"?"text-purple underline underline-offset-4":"text-primaryGray-300")}><span className="hidden lg:block">Hiring</span><span className=" lg:hidden">Employment</span></li>
                    </ul>
